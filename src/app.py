...
class yoloUI:
    def __init__(self):
        ...
        self.cContent = None
        self.style_images_path = 'in/style'
    ...
    def build_network_selection(self):
        ...
        start_styleTransfer_button = Button(network_selection_frame, text='Start Style Transfer', command= self.start_style_transfer)
    ...
    def build_content_selection(self):
        ...
        content_selection_frame = Frame(fLeft, width=640, height=360, bg='lightgray')
        ...
        take_photo_button = Button(content_buttons_frame, text = "Take Photo", command=self.takePhoto)
        select_photo_button = Button(content_buttons_frame, text = "Select Image", command=self.getLocalFile)
        select_photo_button.grid(row= 1,column = 1, padx = 25)
        take_photo_button.grid(row = 1,column = 2)

        self.cContent = Canvas(content_image_frame, width= 640, height = 360,bg ='lightgray')
    ...
    def start_style_transfer(self):
        print(self.content_weight_entry.get(), self.style_weight_entry.get(), self.tv_weight_entry.get())
